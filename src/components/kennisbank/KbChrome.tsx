    ...
    >
      <div className="max-w-7xl mx-auto safe-x py-4 flex items-center justify-between gap-3">
        ...
        <nav className="flex items-center gap-4 sm:gap-6 shrink-0">
          <Link
            href="/kennisbank"
            className="hidden sm:inline-block font-mono text-xs tracking-widest text-[#1E1B4B] hover:text-cyan transition-colors duration-300"
          >
            KENNISBANK
          </Link>
          <Link
            href="/#contact"
            className="font-mono text-xs tracking-widest px-4 sm:px-5 py-3 rounded relative overflow-hidden font-bold text-[#F8FAFC]"
