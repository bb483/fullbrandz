...
const projects = [
  ...
  },
  {
    ...
    description: 'Kassa, reserveringen, bestellen aan tafel, betalen en loyalty in één rustig systeem. AI-automatisering, klaar voor de witte kassa — gemaakt voor de Belgische horeca.',
    tags: ['POS', 'Horeca', 'AI', 'België'],
    year: '2024',
    color: '#0077CC',
  },
  {
